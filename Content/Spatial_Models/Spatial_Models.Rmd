...
MCMC <- buildMCMC(conf)
cMCMC <- compileNimble(MCMC, project = cModel)
samples <- runMCMC(cMCMC, niter = 15000, nburnin = 5000, thin = 10)
```
...
I didn't do a thorough exploration but default NIMBLE MCMC and JAGS seemed similar, while modifying the RW_block sampler in NIMBLE improved mixing a lot.

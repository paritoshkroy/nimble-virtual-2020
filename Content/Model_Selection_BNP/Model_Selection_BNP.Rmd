---
title: "Model selection/comparison/expansion topics: Variable selection, WAIC, and Bayesian non-parametrics"
...
We'll start with a standard random effects meta analysis and then robustify the analysis using Bayesian nonparametric methods.
 ...
 - Side effects of a very popular drug for diabetes called Avandia. 
 - Primary question: Does Avandia uses increase the risk of myocardial infarction (heart attack). 
...
# WAIC can be tricky
 ...
 - The variation used depends on what is monitored in the MCMC (because we need samples of everything considered a parameter)
    - Often you want to monitor all parameters, which is NOT the NIMBLE default.
...
# BNP: more details
 ...
 - In our next version (0.10.0) we'll provide more flexibility for treating each 'observation' that is clustered as having multiple values 

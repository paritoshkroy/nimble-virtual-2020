...
Here are the modules we'll work through for this short course.
 ...
 - Day 1
    ...
    1. [Introduction to NIMBLE](Content/introduction_to_nimble/introduction_to_nimble.html)
    2. [Models in NIMBLE](Content/nimble_models/nimble_models.html)
    3. [Comparing and customizing MCMC](Content/comparing_and_customizing_mcmc/comparing_and_customizing_mcmc.html)
    4. [Improving MCMC](Content/improving_mcmc/improving_mcmc.html)

 - Day 2

    5. [User-defined distributions and functions](Content/user_defined/user_defined.html) 
    6. [User-defined samplers / programming in NIMBLE](Content/user_samplers/user_samplers.html)
    7. [Spatial modeling, part 1](Content/spatial_models/spatial_models.html)
  
 - Day 3
 
    8. [Spatial modeling, part 2](Content/spatial_models/spatial_models.html)
    9. [Model selection, including Bayesian nonparametrics](content/model_selection_bnp/model_selection_bnp.html)
    10a. [Ecological modeling](modules/ecology/ecology.html) 
    10b. [Sequential Monte Carlo](modules/smc/smc.html)
